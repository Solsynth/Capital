...
<template>
  <div class="card bg-base-100 border border-base-200 overflow-hidden transition-colors duration-150 hover:border-base-300">
    <div class="relative aspect-video overflow-hidden">
      ...
      <div class="absolute top-3 right-3 flex gap-1.5">
        <a
          ...
          :href="repo"
          target="_blank"
          class="btn btn-circle btn-xs bg-white/80 hover:bg-white border-none"
        >
    ...
    <div v-if="tags.length > 0 || series" class="px-4 py-3 border-t border-base-200">
