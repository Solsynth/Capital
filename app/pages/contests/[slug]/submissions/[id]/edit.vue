...
const { data: content } = await useAsyncData(
  `contest-edit-${locale.value}-${slug.value}`,
  async () => {
...
const { data: sub } = await useAsyncData(
  ...
  >
    <div class="max-w-2xl mx-auto">
      ...
      >
        ...
        <fieldset class="fieldset">
          <legend class="fieldset-legend">
            {{ t("contests.screenshots") }} ({{ screenshots.length }}/10)
          </legend>
          ...
          <p v-if="uploadError" class="text-error text-xs mt-2">
            {{ uploadError }}
          </p>
        </fieldset>
        ...
        <fieldset class="fieldset">
          ...
          >
            ...
            >
              ...
              <TagsInputItemDelete class="btn btn-xs btn-ghost btn-circle p-0"
                >×</TagsInputItemDelete
              >
            </TagsInputItem>
            <TagsInputInput
            ...
            <TagsInputClear
              v-if="tags.length > 0"
              class="btn btn-xs btn-ghost btn-circle p-0"
              >×</TagsInputClear
            >
          </TagsInputRoot>
        </fieldset>
        ...
        <div class="pt-4">
          ...
          >
            ...
            <span v-else-if="sub.status === 'rejected'">{{
              t("contests.resubmit")
            }}</span>
