...
用户可以通过 [lily@solsynth.dev](mailto:lily@solsynth.dev) 联系我们导出个人信息。

**注意：数据导出完成后，我们将立即删除数据库中导出的数据。这意味着您将无法再访问您的 Solarpass 帐户。我们将使用收到导出请求的电子邮件地址来验证您的身份。这是此流程的最后一步。我们不会再发送任何确认邮件。**
